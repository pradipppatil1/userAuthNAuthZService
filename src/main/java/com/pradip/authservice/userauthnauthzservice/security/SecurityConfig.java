package com.pradip.authservice.userauthnauthzservice.security;
        ...
        return (context) -> {
            if (OAuth2TokenType.ACCESS_TOKEN.equals(context.getTokenType())) {
                context.getClaims().claims((claims) -> {
                    ...
                    Authentication obj = context.getPrincipal();
                    Long userId = ((CustomUserDetails)obj.getPrincipal()).getUserId();
